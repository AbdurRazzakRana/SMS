<%-- 
    ...
    Created on : Mar 26, 2018, 12:39:44 AM
    Author     : razza
--%>
            ...
            <div class="demo">
                <div class="login">
                    ...
                    <div class="login__form">
                        ...
                        <form action="SuperAccount" method="post">
                            <input type="submit"  value="Sign in" style="  
                                   ...
                                   "class="login__submit"> 
                            <!--<input type="submit" class="login_submit" name="secretSignIn" value="Sign in">-->

                        </form>
                        <!--<button type="button" class="login__submit" onclick="secretLogin.java">Sign in</button>-->
                ...
                <!--                <div class="app">
                                    <div class="app__top">
                                        ...
                                        <div class="app__user">
                                            <img src="images/superadmin.jpg" alt="" class="app__user-photo">
